...
switch ($Role) {
    "Server" {
        ...
        $env:FL_RESUME_FROM = "C:\Users\Imane\OneDrive\Bureau\IAGI-S4\Projet_Metier\fraud-detection-pipeline\logs\runs\2026-05-02_13-48-59_imane_FedProx_0.01\checkpoints" 
