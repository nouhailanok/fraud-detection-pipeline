...
$DIR = "C:\Users\Imane\OneDrive\Bureau\IAGI-S4\Projet_Metier\fraud-detection-pipeline"
...
switch ($Role) {
    "Server" {
        ...
        $env:NOM_USER = "imane_FedProx_0.01"
        ...
        $env:FL_RESUME_FROM = "C:\Users\Imane\OneDrive\Bureau\IAGI-S4\Projet_Metier\fraud-detection-pipeline\logs\runs\2026-05-02_18-28-40_imane_FedProx_0.01\checkpoints" 
